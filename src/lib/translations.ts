...
export const translations: Record<string, Record<string, string>> = {
	...
	'sv-SE': {
		...
		toastArchived: 'Utgift arkiverad',
		toastMoved: '"{name}" flyttad till {person}',
		archiveExpense: 'Arkivera utgift',
		saveChanges: 'Spara ändringar',
		selectTemplate: 'Välj en utgift',
		selectTemplateDesc: 'Klicka på en utgift till vänster för att redigera detaljer, andelar och historik, eller skapa en ny utgift.',
